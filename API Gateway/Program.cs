namespace API_Gateway
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                var route = (ep as RouteEndpoint)?.RoutePattern?.RawText ?? ep.DisplayName ?? "<no-route>";
                logger.LogInformation("Registered endpoint: {Route} - DisplayName: {Name}", route, ep.DisplayName);
            }
