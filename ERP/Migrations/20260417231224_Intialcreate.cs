        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveOfferId = table.Column<int>(type: "int", nullable: true),
                    AverageRating = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalReviews = table.Column<int>(type: "int", nullable: false),
                    BrandId = table.Column<int>(type: "int", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    ProductCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CostPrice = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_customers_customer_groups_CustomerGroupId",
                        column: x => x.CustomerGroupId,
                        principalTable: "customer_groups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_customers_users_RegisteredBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_finance_entries_users_RecordedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_invoice_audit_log_users_ChangedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingCash = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_pos_shifts_branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_stock_transfers_users_AuthorizedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchId = table.Column<int>(type: "int", nullable: true),
                    LoggedBy = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_demand_log", x => x.Id);
                    table.ForeignKey(
                        name: "FK_demand_log_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_demand_log_branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "branches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_demand_log_users_LoggedBy",
                        column: x => x.LoggedBy,
                        principalTable: "users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_inventory_adjustments_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_inventory_adjustments_users_AdjustedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sales_orders_branches_BranchId1",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sales_orders_customers_CustomerId1",
                        column: x => x.CustomerId1,
                        principalTable: "customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sales_orders_payment_methods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalSchema: "retail",
                        principalTable: "payment_methods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sales_orders_payment_methods_PaymentMethodId1",
                        column: x => x.PaymentMethodId1,
                        principalSchema: "retail",
                        principalTable: "payment_methods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sales_orders_users_CashierId",
                        column: x => x.CashierId,
                        principalTable: "users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_returns_sales_orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_sales_order_items_warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "warehouses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customers_RegisteredBy",
                table: "customers",
                column: "RegisteredBy");

            migrationBuilder.CreateIndex(
                name: "IX_demand_log_BranchId",
                schema: "retail",
                table: "demand_log",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_demand_log_LoggedBy",
                schema: "retail",
                table: "demand_log",
                column: "LoggedBy");

            migrationBuilder.CreateIndex(
                name: "IX_demand_log_ProductId",
                schema: "retail",
                table: "demand_log",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_finance_entries_RecordedBy",
                schema: "retail",
                table: "finance_entries",
                column: "RecordedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_adjustments_AdjustedBy",
                schema: "retail",
                table: "inventory_adjustments",
                column: "AdjustedBy");

            migrationBuilder.CreateIndex(
                name: "IX_inventory_adjustments_ProductId",
                schema: "retail",
                table: "inventory_adjustments",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_invoice_audit_log_ChangedBy",
                schema: "retail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_order_items_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_order_items_WarehouseId",
                table: "sales_order_items",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_BranchId1",
                table: "sales_orders",
                column: "BranchId1");

            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_CashierId",
                table: "sales_orders",
                column: "CashierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_CustomerId1",
                table: "sales_orders",
                column: "CustomerId1");

            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_PaymentMethodId",
                table: "sales_orders",
                column: "PaymentMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_PaymentMethodId1",
                table: "sales_orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_transfers_AuthorizedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_transfers_TransferReference",
                table: "stock_transfers",
